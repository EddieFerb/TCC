# Path: ambiente/.venv/lib/python3.10/site-packages/contourpy/util/_build_config.py
...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/private/var/folders/g6/rgtlsw6n123b0gt5483s5_cm0000gn/T/build-env-3yq1kv6h/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/Users/runner/work/contourpy/contourpy/.mesonpy-kxb7j3u1/lib/contourpy/util",
        source_dir=r"/Users/runner/work/contourpy/contourpy/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/Users/runner/work/contourpy/contourpy/.mesonpy-kxb7j3u1/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
